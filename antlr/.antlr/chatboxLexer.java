...
public class chatboxLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "ADD", "DELETE", "INCREASE", 
			"DECREASE", "SET", "IF", "THEN", "DISCOUNT", "ID", "NAME", "QUANTITY", 
			"TIME", "MONEY", "WS"
		};
	}
	...
	public chatboxLexer(CharStream input) {
		super(input);
